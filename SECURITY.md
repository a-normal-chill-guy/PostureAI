...
This can be done by navigating to the "Security" tab of the repository where you found the issue at https://github.com/a-normal-chill-guy/PostureAI/security.
